//
//  EmptyDataSetView+Config.swift
//  YFEmptyDataSet
//
//  Created by sky on 2022/10/6.
//
...
extension EmptyDataSetView {
    ...
    /// The dataset uses a fixed font style by default, if no attributes are set. If you want a different font style, return a attributed string.
    @discardableResult
    public func descriptionString(_ attributedString: NSAttributedString?) -> Self {
    ...
    @discardableResult
    public func verticalSpace(_ space: CGFloat, for element: EmptyDataSetElement) -> Self {
        verticalSpacing?[element] = space
        return self
    }
    ...
    public func shouldDisplay(_ bool: Bool) -> Self {
        if let superview = self.superview {
            isHidden = !(bool && superview.isDataEmpty())
        }
        return self
    }
    ...
    @discardableResult
    public func didTapContentView(_ closure: ((_ emptyDataSetView: EmptyDataSetView) -> (Void))?) -> Self {
        didTapEmptyViewHandle = closure
        return self
    }
    
    /// Tells the delegate that the action button was tapped.
    @discardableResult
    public func didTapDataButton(_ closure: ((_ emptyDataSetView: EmptyDataSetView) -> (Void))?) -> Self {
        didTapEmptyButtonHandle = closure
        return self
    }
    
    /// Tells the delegate that the empty data set will appear.
    @discardableResult
    public func emptyViewWillAppear(_ closure: @escaping () -> (Void)) -> Self {
    ...
    @discardableResult
    public func emptyViewDidAppear(_ closure: @escaping () -> (Void)) -> Self {
    ...
    @discardableResult
    public func emptyViewWillDisappear(_ closure: @escaping () -> (Void)) -> Self {
    ...
    @discardableResult
    public func emptyViewDidDisappear(_ closure: @escaping () -> (Void)) -> Self {
